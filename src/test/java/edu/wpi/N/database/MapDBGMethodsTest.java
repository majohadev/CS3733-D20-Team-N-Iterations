...
public class MapDBGMethodsTest {
  ...
  */
  ...
  //  /**
  //   * Tests that addNode(nodeID, x, y, floor, building, nodeType, longName, shortName,
  // teamAssigned)
  ...
  //  /**
  //   * Tests that cost(currNode, nextNode) returns the correct cost value for nodes in the
  // database
  //   */
  //  @Test
