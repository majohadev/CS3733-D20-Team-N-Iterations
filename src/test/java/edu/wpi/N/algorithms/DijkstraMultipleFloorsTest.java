...
public class DijkstraMultipleFloorsTest {
  Algorithm myDijkstra = new Algorithm();

  public DijkstraMultipleFloorsTest() throws DBException {}
  ...
  public static void initialize()
    ...
    InputStream inputNodes =
        edu.wpi.N.algorithms.DijkstraMultipleFloorsTest.class.getResourceAsStream(
            "../csv/FourFloorsTestNode.csv");
    InputStream inputEdges =
        edu.wpi.N.algorithms.DijkstraMultipleFloorsTest.class.getResourceAsStream(
            "../csv/FourFloorsTestEdges.csv");
