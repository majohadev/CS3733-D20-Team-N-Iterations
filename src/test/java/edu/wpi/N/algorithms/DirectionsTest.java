...
public class DirectionsTest {
  ...
  //  /**
  //   * Directions for path from first restroom floor 4 to Gastroentology Associates Wording could
  // be
  ...
  // false);
  //    ArrayList<Directions> directions = path.getDirections();
  ...
  //
  //  /**
  //   * Directions for path from far left stairwell floor 4 to first elevator (bottom left),
  // (4.5/5)
  //   *
  //   * @throws DBException
  //   */
  ...
  //  //
  //  //  /**
  //  //   * Directions for path from Rheumatology Center to Pulmonary Services Pulmonary services
  // not
  //  // Works
  //  //   * (2.5/5), doesn't detect turn into Pulmonary unless turn threshold is 20 deg Best
  // solution
  //  // is
