...
public class GetPathWithStopAStarTest {
   ...
   */
  @Test
  public void getPathWithStopNodeSameFloorAStarTest() throws DBException {
    DbNode start = MapDB.getNode("H011000000");
    DbNode end = MapDB.getNode("H081000000");
    DbNode stop = MapDB.getNode("H061000000");
    Pair<Path, Path> actualPathPair = myAStar.getPathWithStop(start, end, stop, false);
   ...
   */
  @Test
  public void getPathWithStopNodeDifferentFloorAStarTest() throws DBException {
    DbNode start = MapDB.getNode("H011000000");
   ...
   */
  @Test
  public void getPathWithStopNodeTypeSameFloorAStarTest() throws DBException {
    DbNode start = MapDB.getNode("H011000000");
    DbNode end = MapDB.getNode("H061000000");
    Pair<Path, Path> actualPathPair = myAStar.getPathWithStop(start, end, "STAI", false);
   ...
   */
  @Test
  public void getPathWithStopNodeTypeDifferentFloorAStarTest() throws DBException {
   ...
   */
  @Test
  public void getPathWithStopNodeDifferentFloorHandicapAStarTest() throws DBException {
    DbNode start = MapDB.getNode("H021000000");
    DbNode end = MapDB.getNode("H053000000");
    DbNode stop = MapDB.getNode("H081000000");
    Pair<Path, Path> actualPathPair = myAStar.getPathWithStop(start, end, stop, true);
