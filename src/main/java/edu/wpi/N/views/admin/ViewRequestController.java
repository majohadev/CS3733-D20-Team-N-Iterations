...
public class ViewRequestController implements Controller, Initializable {
    ...
    private void initializeTable() {
        ...
        nodeID.setCellValueFactory(new NewAdminController.nodeLongName());
        ...
        // Initializes Columns for Language Table (Filling Requests) and Request Table (Viewing, Accepting, Denying)
        tb_RequestTable
                .getColumns()
                .addAll(
