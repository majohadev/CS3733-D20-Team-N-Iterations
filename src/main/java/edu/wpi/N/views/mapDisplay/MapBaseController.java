...
public class MapBaseController implements Controller {
  ...
  public void initialize() throws DBException {
    ...
    initPathAnim();
    setFaulknerDefaults();
    // pn_routeNodes.layoutXProperty().addListener((nval) -> System.out.println("layout X " +
    // nval));
    // pn_routeNodes.layoutYProperty().addListener((nval) -> System.out.println("layout Y " +
    // nval));
    // pn_movableMap.layoutXProperty().addListener((nval) -> System.out.println("layout X m" +
    // nval));
    // pn_movableMap.layoutYProperty().addListener((nval) -> System.out.println("layout Y m" +
    // nval));
  }
