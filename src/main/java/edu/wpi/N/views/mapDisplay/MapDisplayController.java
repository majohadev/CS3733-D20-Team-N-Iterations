...
public class MapDisplayController implements Controller, Initializable {
    ...
    Pane pn_changeFloor;
    @FXML
    JFXTextField txt_firstLocation;
    @FXML
    JFXTextField txt_secondLocation;
    @FXML
    JFXListView<DbNode> lst_firstLocation;
    @FXML
    JFXListView<DbNode> lst_secondLocation;
    // @FXML JFXButton btn_searchdoc;
    @FXML
    JFXTextField txt_doctorname;
    @FXML
    ListView<Doctor> lst_doctornames;
    // @FXML Button btn_searchdoc;
    @FXML
    ListView<DbNode> lst_doctorlocations;
    @FXML
    Button btn_findpathdoc;
    @FXML
    JFXButton btn_findPath;
    @FXML
    JFXButton btn_home;
    @FXML
    private JFXButton btn_floors;
    @FXML
    TitledPane pn_locationSearch;
    @FXML
    Accordion acc_search;
    @FXML
    Text txt_description;
    @FXML
    JFXCheckBox handicapp1;
    @FXML
    JFXCheckBox handicapp2;

    @FXML
    StackPane mapContainer; // Reference to the StackPane containing embded map
    @FXML
    AnchorPane googleMapView;

    @FXML
    JFXButton btn_faulkner;
    @FXML
    JFXButton btn_main;
    @FXML
    ...
    @FXML
    MapBaseController mapBaseController; // Reference to the embedded map
    ...
    public void switchToMain() throws DBException{
        try{
            mapBaseController.setFloor("45 Francis", );
        }
    }
